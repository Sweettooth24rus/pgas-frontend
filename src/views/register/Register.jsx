    ...
    return(
        <div className="Register">
            ...
            <form onSubmit={register}>
                <TextField onChange={e => setUserCredentials({...userCredentials, username: e.target.value})} className="Register__input" id="outlined-basic" label="Номер зачётной книжки" variant="outlined" />
                ...
                <TextField onChange={e => setUserCredentials({...userCredentials, phone: e.target.value})} className="Register__input" id="outlined-basic" label="Группа" variant="outlined" />

        ...
        <div className={'Recipes'}>
            ...
            {/* {recipes.map(recipe => {
                if(recipe.name.toLowerCase().includes(filter.toLowerCase())){
                    return( */}
                    <Link style={{textDecoration: 'none', color: 'green'}} to={'/pickle/add'}>Добавить заявку</Link>
                        <div className={'Recipes__recipeBlock'}>
                        <table bordercolor="black" rules="rows" width="100%">
                        <tr>
                        <td>2 семестр 2021 года</td>
                        <td align="right">Закрыт</td>
                        </tr>
                        <tr>
                                                <td>1 семестр 2021 года</td>
                                                <td align="right">Закрыт</td>
                                                </tr>
                        </table>
